const ErrorPage = () => {
  return (
    <div className="bg-gradient-to-t to-[#b3dae1] from-[#8acfd6] bg-no-repeat h-screen flex justify-center items-center flex-col text-cyan-600" >
      ...
      <a href="https://www.freepik.com/free-vector/page-found-concept-illustration_7887410.htm#query=404%20page%20png&position=0&from_view=keyword&track=ais_hybrid&uuid=6a0cf2e0-e807-47ff-a08b-e713c3777751">Image by storyset on Freepik</a>
    </div>
  );
}
